...
public class ConfigHandler {
    ...
    static String sanitizeWebBind(String raw) {
        ...
        if (bind.indexOf(':') >= 0 && bind.length() <= 45 && bind.chars().allMatch(c ->
    ...
    private static List<Map<String, String>> namedRules(List<BlacklistRule> rules) {
        List<Map<String, String>> out = new ArrayList<>();
        if (rules == null) {
            return out;
        }
